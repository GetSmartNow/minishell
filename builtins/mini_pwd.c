...
/*   Updated: 2021/03/23 21:36:37 by ctycho           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../minishell.h"

static char			*mini_oldpwd_1(t_mass *list, char *tmp_1, int *flag)
{
	t_mass			*tmp;
...
void				mini_oldpwd(t_mini *s)
{
	...
	tmp_1 = NULL;
	line = NULL;
	tmp_1 = mini_oldpwd_1(s->head, tmp_1, &flag);
	if (flag == 0)
	{
	...
	flag = 0;
	line = NULL;
	line = mini_oldpwd_1(s->head_x, line, &flag);
	if (flag == 0)
	{
